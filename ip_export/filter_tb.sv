...
module autogenerated_tb();
    ...
    NiFpgaIPWrapper_filter_ip UUT (
        ...
        .ctrlind_03_Command_Out_Valid(o_ip_cmd_valid),
        .ctrlind_04_Command_Out_Remove(o_ip_cmd_remove),
        .ctrlind_05_Command_Out_Edit(o_ip_cmd_edit),
        .ctrlind_06_Command_Out_Add(o_ip_cmd_add),
        .ctrlind_07_Command_Out_nanoseconds(o_ip_cmd_nanoseconds),
        .ctrlind_08_Command_Out_seconds(o_ip_cmd_seconds),
        .ctrlind_09_Command_Out_remaining_qty(o_ip_cmd_remaining_qty),
        .ctrlind_10_Command_Out_canceled_qty(o_ip_cmd_canceled_qty),
        .ctrlind_11_Command_Out_executed_qty(o_ip_cmd_executed_qty),
        .ctrlind_12_Command_Out_price(o_ip_cmd_price),
        .ctrlind_13_Command_Out_symbol(o_ip_cmd_symbol),
        .ctrlind_14_Command_Out_quantity(o_ip_cmd_quantity),
        .ctrlind_15_Command_Out_orderId(o_ip_cmd_orderid),
        .ctrlind_16_Command_Out_side(o_ip_cmd_side),
        .ctrlind_17_Command_Out_type(o_ip_cmd_type),
    ...
    begin
        ...
        begin
            ...
            $display("  {");
            $display("           valid: %4d", o_ip_cmd_valid);
            $display("            type: %4d", o_ip_cmd_type);
            $display("            side: %4x", o_ip_cmd_side);
            ...
            $display("    executed_qty: %6d", o_ip_cmd_executed_qty);
            $display("    canceled_qty: %6d", o_ip_cmd_canceled_qty);
            $display("   remaining_qty: %6d", o_ip_cmd_remaining_qty);
            $display("         seconds: %6d", o_ip_cmd_seconds);
            $display("     nanoseconds: %6d", o_ip_cmd_nanoseconds);
            $display("             add: %6d", o_ip_cmd_add);
            $display("            edit: %d", o_ip_cmd_edit);
            $display("          remove: %d", o_ip_cmd_remove);
            $display("      }\n");
            #(duty_cycle*2);
        end
