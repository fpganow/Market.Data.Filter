...
//        filter_bench.gen_messages();
        ...
        begin
            $display("  - Retrieving command #%d", counter);
            filter_bench.get_next_command(ob_cmd);
            $display("    %d", ob_cmd.cmd_type());

            // Use object
            in_ip_command_in_valid = 1;
// in_ip_command_in_type = ob_cmd.cmd_type()
// in_ip_command_in_side;
// in_ip_command_in_orderid;
// in_ip_command_in_quantity;
// in_ip_command_in_symbol;
// in_ip_command_in_price;
// in_ip_command_in_executed_qty;
// in_ip_command_in_canceled_qty;
// in_ip_command_in_remaining_qty;
// in_ip_command_in_seconds;
// in_ip_command_in_nanoseconds;

//#        ob_cmd = []
//#        ob_cmd.append( ('cmd_type', cmd_type) )
//#        return ob_cmd
//    def dict_for_cmd(self, cmd_type: int) -> Dict:
//        ob_cmd = {}
//        ob_cmd['cmd_type'] = cmd_type
//       return ob_cmd
            counter++;
            #(period*1);
        end
