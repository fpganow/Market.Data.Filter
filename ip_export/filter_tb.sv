...
module autogenerated_tb();
    ...
    begin
        ...
        // Read Debug Values
        wait (out_ip_debug_valid == 1 && Clk40Derived7x2B40MHz == 1);
        ...
        $display("  Waiting for Valid Commands to come out");
        wait (out_ip_command_out_valid == 1);
        $display("  out_ip_command_out_valid: %d", out_ip_command_out_valid);
        $display("  out_ip_command_out_side: %d", out_ip_command_out_side);
        $display("  out_ip_command_out_type: %d", out_ip_command_out_type);
        $display("+-----------------------------------------------------------------------------+");
